...
class PerformanceIndicatorPolicy
{
    ...
    {
        return $user->can('view_any_performance::indicator');
    }
    ...
    {
        return $user->can('view_performance::indicator');
    }
    ...
    {
        return $user->can('create_performance::indicator');
    }
    ...
    {
        return $user->can('update_performance::indicator');
    }
    ...
    {
        return $user->can('delete_performance::indicator');
    }
    ...
    {
        return $user->can('delete_any_performance::indicator');
    }
     ...
     */
    public function replicate(User $user, PerformanceIndicator $performanceIndicator): bool
    {
